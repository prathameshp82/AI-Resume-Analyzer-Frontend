      ...
      <div className="animate-scale-in w-full max-w-md">
        <div className="rounded-2xl border border-white/60 bg-white/80 p-6 shadow-2xl shadow-indigo-500/10 backdrop-blur-xl sm:rounded-3xl sm:p-10">
          ...
          <div className="mb-6 text-center sm:mb-8">
            <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-xl gradient-bg shadow-lg shadow-indigo-500/25 sm:mb-4 sm:h-14 sm:w-14 sm:rounded-2xl">
